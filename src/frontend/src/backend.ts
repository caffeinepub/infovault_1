...
export class Backend implements backendInterface {
    ...
    async createAccount(arg0: string, arg1: string, arg2: string, arg3: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async createDocument(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateAccount(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<Account> {
        if (this.processError) {
            try {
